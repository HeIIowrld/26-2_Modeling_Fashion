...
// budget inputs: format min/max with thousand separators
function _formatCurrencyInput(el) {
  if (!el) return;
...
_formatCurrencyInput($("f-min-budget"));
_formatCurrencyInput($("f-max-budget"));
